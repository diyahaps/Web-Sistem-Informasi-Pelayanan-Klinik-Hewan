    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-xl-4 col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                <div class="rounded h-100">
                    <div class="section-title">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">Resend Aktivasi Email</h5>
                        <p class="mb-4">Silahkan masukan email anda untuk melakukan aktivasi email ulang.</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-8 col-lg-8 wow slideInUp" data-wow-delay="0.3s">
                ...
                @endif
                <form method="POST" action="{{ route('auth.activate.post') }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-12">
