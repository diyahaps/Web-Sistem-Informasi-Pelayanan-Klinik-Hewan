...
@section('title','Reservasi Details | Engil Pet Vet')
@section('content')
<section class="section">
    <div class="section-header">
        <h1><i class="fa fa-th-large"></i> Reservasi Details</h1>
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('reservasi.index') }}">Reservasi</a></div>
            <div class="breadcrumb-item active"><a href="{{ route('reservasi.details', $reservasi->id_reservasi) }}">Reservasi Details</a></div>
...
@section('sweetAlert')
    <script type="text/javascript">
        $('.batal').click(function()
        {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/admin/reservasi/"+id+"/batal";
              }
            });
        });
        $('.konfirmasi').click(function()
        {
            ...
            swal({
              title     : "Info",
              text      : "Apakah reservasi "+nama+" akan dikonfirmasi?",
              icon      : "info",
              buttons   : true,
              dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/admin/reservasi/"+id+"/konfirmasi";
              }
            });
        });
    </script>
