...
@section('title','Reservasi Batal | Engil Pet Vet')
@section('content')
<section class="section">
    <div class="section-header">
        <h1><i class="fa fa-times"></i> Reservasi Batal</h1>
    </div>
                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $no }}.</td>
                                        <td>
                                            <a href="{{ route('reservasi.batal.detail', $data->id_reservasi) }}">{{ $data->kode_reservasi }}</a>
                                        </td>
                                        ...
                                        <td>
                                            @if($data->status_reservasi == "Batal")
                                                <div class="badge badge-danger">{{ $data->status_reservasi }}</div>
                                            ...
                                            @else
                                                <div class="badge badge-warning">{{ $data->status_reservasi }}</div>
                                            @endif
                                        </td>
                                    </tr>
