...
@section('title','Pembayaran | Engil Pet Vet')
@section('content')
<section class="section">
    <div class="section-header">
        <h1><i class="fa fa-database"></i> Pembayaran</h1>
    </div>
                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $no }}.</td>
                                        <td>
                                            <a href="{{ route('pembayaran.details', $data->id_reservasi) }}">{{ $data->kode_reservasi }}</a>
                                        </td>
