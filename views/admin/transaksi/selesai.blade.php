...
@section('title','Reservasi Selesai | Engil Pet Vet')
@section('content')
<section class="section">
    <div class="section-header">
        <h1><i class="fa fa-check"></i> Reservasi Selesai</h1>
    </div>
                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $no }}.</td>
                                        <td>
                                            <a href="{{ route('reservasi.selesai.detail', $data->id_reservasi) }}">{{ $data->kode_reservasi }}</a>
                                        </td>
