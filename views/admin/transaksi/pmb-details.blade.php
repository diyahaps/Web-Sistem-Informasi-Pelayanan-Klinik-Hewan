...
@section('title','Pembayaran Details | Engil Pet Vet')
@section('content')
<section class="section">
    <div class="section-header">
        <h1><i class="fa fa-th-large"></i> Pembayaran Details</h1>
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('pembayaran.index') }}">Pembayaran</a></div>
            <div class="breadcrumb-item active"><a href="{{ route('pembayaran.details', $reservasi->id_reservasi) }}">Pembayaran Details</a></div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-5">
                                <div class="col-md-9 text-left" style="margin-top: 105px;">
                                    <a href="{{ route('pembayaran.index') }}" class="btn btn-dark"><i class="fa fa-arrow-left"></i> Kembali</a>
                                    <button data-toggle="modal" data-target=".qris" class="btn btn-warning"> Pembayaran QRIS</button>
                                    <button data-toggle="modal" data-target=".cash" class="btn btn-info"> Pembayaran CASH</button>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3 mt-3">
...
<div class="modal fade qris" tabindex="-1" role="dialog" id="">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-warning">Pembayaran by QRIS</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-danger">&times;</span>
                </button>
            </div>
            <form action="{{ route('pembayaran.qris', $reservasi->id_reservasi) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <div class="col-md-8 text-center mt-3">
                            <img src="{{ asset('img') }}/qris.png" width="100">
                            <br>
                            <img src="{{ asset('img') }}/qr-code.jpeg" width="300">
                        </div>
                    </div>   
                </div>
                <div class="modal-footer">
                    Sudah bayar? <button type="submit" class="btn btn-warning ml-3">Klik disini</button>
                </div>
            </form>
        </div>
    </div>
</div>
<div class="modal fade cash" tabindex="-1" role="dialog" id="">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary">Pembayaran CASH</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-danger">&times;</span>
                </button>
            </div>
            <form action="{{ route('pembayaran.cash', $reservasi->id_reservasi) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <div class="col-md-8 text-center mt-3">
                            <img src="{{ asset('img') }}/cash.png" width="250">
                            <br>
                            Apakah sudah melakukan pembayaran cash?
                        </div>
                    </div>   
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary ml-3">Ya, Sudah dibayar</button>
                </div>
            </form>
        </div>
    </div>
